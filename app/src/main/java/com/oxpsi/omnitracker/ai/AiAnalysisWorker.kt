...
class AiAnalysisWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        val analysisImages = com.oxpsi.omnitracker.data.buildAnalysisImages(pendingUpdate, recipeDao)
        val imageLabels = analysisImages.map { it.label }
        val contextPreamble = com.oxpsi.omnitracker.data.buildImageContextPreamble(imageLabels)
        val analysisText = contextPreamble + com.oxpsi.omnitracker.data.buildAnalysisNote(pendingUpdate, recipeDao)
